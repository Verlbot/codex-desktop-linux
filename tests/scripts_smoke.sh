...
EOF
    ...
    assert_contains "$REPO_DIR/docs/retired-workflows/ci.yml" "tests/fixtures/create-packaged-app-fixture.sh codex-app"
    assert_contains "$REPO_DIR/docs/retired-workflows/ci.yml" "bash scripts/ci/run-node-checks.sh"
